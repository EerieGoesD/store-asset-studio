...
[Partner Center](https://partner.microsoft.com), then edit `Package.appxmanifest` so these
match **exactly** what Partner Center shows under *Product management > Product identity*:
